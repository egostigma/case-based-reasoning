...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{ clean($controller_text) . ($method != 'index' ? ' - ' . $method_text: '') }}
            |  {{ clean($ci->config->item('app_name'))}}</title>
	...
	<!-- begin::Body -->
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-light m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							...
							<form id="form_signin" class="m-login__form m-form" method="post">
						...
						<div class="m-login__signup m--hide">
							...
							<form  class="m-login__form m-form">
								...
								<div class="m-login__form-action  m--hide">
		...
		<script src="<?=base_url('assets/vendors/base/vendors.bundle.js');?>" type="text/javascript">
		</script>
		<script src="<?=base_url('assets/demo/default/base/scripts.bundle.js');?>" type="text/javascript">
		</script>
